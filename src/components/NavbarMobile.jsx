          ...
          <div className="dropdown-menu-mobile">
            ...
            {isLoggedIn && (
              <>
                ...
                <div className="icon-text-element" onClick={toggleNotifications} style={{cursor: 'pointer'}}>
                  <p>
                    <span style={{color: "#fa920a", fontWeight:"600"}}>{unreadNotificationCount > 0 ? unreadNotificationCount : ''}</span> Notifications
                  </p>
                </div>
                ...
                <div className="profile-menu" style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                  <Link to="/user/profile" onClick={closeMenu} style={{display:"flex", alignItems: "center", gap: "8px"}}>
                    <img
